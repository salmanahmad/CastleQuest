...
public class MD5 { //_global.MD5 = new Object();
...
//
public static function core_md5 (x:Array, len:int):Array{
var olda:Number;
var oldb:Number;
var oldc:Number;
var oldd:Number; 
...
var result:Number = safe_add(bit_rol(safe_add(safe_add(a, q), safe_add(x, t)), s),b);
return result;
}
...
//
public static function core_hmac_md5 (key:String, data:String):Array{
...
//
public static function str2binl (str:String):Array{
var bin:Array = new Array();
var mask:Number = (1 << chrsz) - 1;
var max:Number = str.length * chrsz;
for(var i:int = 0; i < max; i += chrsz){
// bin[i>>5] |= (str.charCodeAt(i / this.chrsz) & mask) << (i%32); // original code
bin[i>>5] |= (str.charCodeAt(i / chrsz) & mask) << (i&31); // proposed optimization
}
return bin;
}
 ...
 */
public static function binl2str (bin:Array):String{
var str:String = "";
var mask:Number = (1 << chrsz) - 1;
 ...
 */
public static function binl2hex (binarray:Array):String{
 ...
 */
public static function binl2b64 (binarray:Array):String{
var tab:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
var str:String = "";
var max:int = binarray.length * 4;
var m4x:int = 4*max;
for(var i:int = 0; i < max; i += 3){
